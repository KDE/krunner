...
protected:
...
#if KRUNNER_ENABLE_DEPRECATED_SINCE(5, 83)
    /**
     ...
     * @deprecated Since 5.83, create the QAction instance manually
     */
    KRUNNER_DEPRECATED_VERSION(5, 83, "create the QAction instance manually")
     ...
     * @deprecated Since 5.83, deprecated for lack of usage
     */
    KRUNNER_DEPRECATED_VERSION(5, 83, "deprecated for lack of usage")
    void removeAction(const QString &id);

    /**
     * Returns the action associated with the id
     * @deprecated Since 5.83, create the QAction instances manually and store them in a custom container instead
     */
    KRUNNER_DEPRECATED_VERSION(5, 83, "create the QAction instances manually and store them in a custom container instead")
     ...
     * @deprecated Since 5.83, use a custom container to store the QAction instances instead
     */
    KRUNNER_DEPRECATED_VERSION(5, 83, "use a custom container to store the QAction instances instead")
    void clearActions();
#endif
